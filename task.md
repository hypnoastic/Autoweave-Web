...
| T02 | refine shell geometry, collapse alignment, top-bar search, sidebar clutter, and profile menu behavior | P0 | [x] | light/dark screenshots, expanded/collapsed shell checks, profile menu opens in live shell |
